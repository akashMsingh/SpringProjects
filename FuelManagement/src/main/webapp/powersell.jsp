      ...
      <c:if test="${not empty errorMsg}">
       ...
       <div class="dropdown">
         ...
         <tr>
            ...
            <td><input type="text" name="purate" value="<%=ssdao.getAvgPower()%>" readonly></td>
         </tr>
         ...
         <tr>
           <td>Total Stock: </td>
           <td><input type="text" placeholder="" name="totalStock" value="<%=power%>" required readonly class="ts"></td>
         </tr> 
